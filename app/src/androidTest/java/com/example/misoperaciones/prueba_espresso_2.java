...
public class prueba_espresso_2 {
    ...
    public void prueba_espresso_2() {
        ...
        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.boton1), withText("Multiplicar"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction materialButton4 = onView(
                allOf(withId(R.id.btnmenu3), withText("MENU"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
